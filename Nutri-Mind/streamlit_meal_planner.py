...
st.set_page_config(page_title=" Nutri-Mind", page_icon="🍴")

st.title("Nutri-Mind (PLAN YOUR HEALTH)")
st.divider()

st.write(
    "Welcome to Nutri-Mind - your AI-powered meal planner! Nutri-Mind tailors personalized meal plans based on your unique information to help you achieve your health and wellness goals. Whether you're looking to balance your calories, manage your macronutrients, or simply explore delicious and nutritious meal options, NutriGenius has got you covered.")
st.markdown("*Powered by Llama-3 AI*")

st.markdown("*How it's work*")
st.write(" 1) Tell Us About Yourself: Share your name, age, weight, height, and gender.")
st.write(" 2) Get Your Meal Plan: NutriGenius calculates your daily calorie needs and creates a customized meal plan that meets your dietary requirements.")

st.markdown("*Why NutriMind?*")
st.write("**Personalized Recommendations:** Get meal plans that suit your lifestyle and preferences.")
st.write("**Balanced Nutrition:** Ensure your meals have the right balance of calories and macronutrients.")
st.write("**AI-Driven:** Benefit from the advanced Llama-3 AI, delivering intelligent and delicious meal suggestions.")
...
hide_streamlit_style = """
                    ...
                    footer:after {
                    content:'Built by Furqan and Team'; 
                    visibility: visible;
    	            display: block;
    	            position: relative;
